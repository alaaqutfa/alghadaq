...
<head>
    ...
    <title>ALGHADAQ - IT | TERMS & CONDITIONS</title>
...
<body>
    ...
    <p>Welcome to www.alghadaqit.tech!</p>

    <p>These terms and conditions outline the rules and regulations for the use of ALGHADAQ INFORMATION TECHNOLOGY
        NETWORK SERVICES L.L.C's Website, located at https://alghadaqit.tech/.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
        www.alghadaqit.tech if you do not agree to take all of the terms and conditions stated on this page.</p>
    ...
    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all
        ...
        Company's stated services, in accordance with and subject to, prevailing law of ae. Any use of the above
    ...
    <p>We employ the use of cookies. By accessing www.alghadaqit.tech, you agreed to use cookies in agreement with the
        ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C and/or its licensors own the
        intellectual property rights for all material on www.alghadaqit.tech. All intellectual property rights are
        reserved. You may access this from www.alghadaqit.tech for your own personal use subjected to restrictions set
        in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C” maintains the https://www.alghadaqit.tech/ Website
            ("Site").</li>
        <li>United Arab of Emirates is our country of domicile” and stipulate that the governing law is the local law.
        </li>
        <li>Any purchase, dispute or claim arising out of or in connection with this website shall be governed and
            construed in</li>
        <li>accordance with the laws of UAE”</li>
        <li>Visa or MasterCard debit and credit cards in AED will be accepted for payment</li>
        <li>The displayed price and currency at the checkout page, will be the same price and currency printed on the
            Transaction</li>
        <li>Receipt and the amount charged to the card will be shown in your card currency”.</li>
        <li>We will not trade with or provide any services to OFAC and sanctioned countries</li>
        <li>Customer using the website who are Minor /under the age of 18 shall not register as a User of the website
            and shall</li>
        <li>not transact on or use the website</li>
        <li>Cardholder must retain a copy of transaction records and https://www.alghadaqit.tech/ policies and rules
        </li>
        <li>User is responsible for maintaining the confidentiality of his account</li>
        <li>Republish material from www.alghadaqit.tech</li>
        <li>Sell, rent or sub-license material from www.alghadaqit.tech</li>
        <li>Reproduce, duplicate or copy material from www.alghadaqit.tech</li>
        <li>Redistribute content from www.alghadaqit.tech</li>
    </ul>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views and opinions of
        ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the extent permitted by applicable laws,
        ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C shall not be liable for the Comments or for any
    ...
    <p>ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C reserves the right to monitor all Comments and to remove
    ...
    <p>You hereby grant ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C a non-exclusive license to use,
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of ALGHADAQ
        INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C; and (d) the link is in the context of general resource
        information.</p>
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C. Please include
        your name, your organization name, contact information as well as the URL of your site, a list of any URLs from
    ...
    <p>No use of ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C's logo or other artwork will be allowed for
