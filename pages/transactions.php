        ...
        <ul>
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item" href="transactions-ar.php?s=<?php echo $_GET['s'] ?>">العربية</a></li>
              </ul>
            </div>
          </li>
    ...
    <div class="container">
      <form method="POST" class="d-flex justify-content-center align-items-center flex-column my-3">
        ...
        <div class="input-group mb-3 position-relative">
          ...
          <input type="text" name="phone" class="form-control" placeholder="Your phone" aria-label="phone" aria-describedby="basic-addon1" required />
          <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
            <span class="visually-hidden">*</span>
          </span>
        </div>
        ...
        <div class="w-100 d-flex justify-content-center align-items-center mb-3">
          <div class="input-group w-50 position-relative">
            ...
            <input type="text" name="name" class="form-control" placeholder="First Name" aria-label="FirstName" required />
          ...
          <div class="input-group w-50 position-relative">
            ...
            <input type="text" name="nickname" class="form-control" placeholder="Second Name" aria-label="SecondName" required />
            <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
              <span class="visually-hidden">*</span>
            </span>
          </div>
        ...
        <div class="input-group mb-3 position-relative">
          ...
          <input type="text" name="city" class="form-control" placeholder="Your city" aria-label="city" aria-describedby="basic-addon1" required />
          <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
            <span class="visually-hidden">*</span>
          </span>
        </div>
        ...
        <div class="input-group mb-3 position-relative">
          ...
          <input type="text" name="address" class="form-control" placeholder="Your address" aria-label="address" aria-describedby="basic-addon1" required />
          <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
            <span class="visually-hidden">*</span>
          </span>
        </div>
        ...
        <div class="input-group mb-3 position-relative">
          ...
          <input type="number" name="The amount" class="form-control" placeholder="Amount" aria-label="amount" aria-describedby="basic-addon1" required />
          <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
            <span class="visually-hidden">*</span>
          </span>
        </div>
        <!-- // ? Description -->
        <div class="input-group mb-3 position-relative">
          <span class="input-group-text"><i class='bx bx-notepad'></i> Description </span>
          <textarea class="form-control" name="desc" aria-label="With textarea" required></textarea>
          <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
            <span class="visually-hidden">*</span>
          </span>
        </div>
        <button type="submit" name="submit" class="w-50 btn btn-success">Submit</button>
      </form>
    </div>
  </main>
  <!-- End #main -->
