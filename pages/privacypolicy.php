...
<head>
    ...
    <title>ALGHADAQ - IT | Privacy Policy</title>
</head>
...
<body>
    ...
    <span>
        We deliver our
        Products to all Countries and mainly UAE. Shipping will be done by a third-party courier.<br>
        Delivery within UAE cities shall be in 1 – 2 working days and from 4 to 10 working Days to Other Countries. UAE
        Delivery Fees will be a Flat Rate of AED: 10 and Delivery Fees outside UAE will be mentioned on the checkout
        page depending on the country and location.
        Avoid any delivery delay by providing your full address along with your contact details.
    </span>
    <p>PAYMENT CONFIRMATION </p>
    <span>Once the payment is made, the confirmation notice will be sent to the client via email within 24 hours of
        receipt.</span>
    <p>REFUND POLICY</p>
    <span>Refunds will be done only through the Original Mode of Payment and will be processed within 10 to 45 days
        depends on the issuing bank of the credit card.</span>
    <p>RETURN POLICY</p>
    <span>
        We accept returns within 7 days of receipt, only if their delivery packaging has not been opened or the products
        are damaged or wrong product. Please notify us and return the box in its original packaging. In such instances,
        we will endeavour to send you another or refund the payment. We can only accept returns of products that have
        not been tampered with, are sealed and remain in the original packaging. If all these conditions are met, please
        ship your products back to us using a registered courier service and we will issue a full refund. Please note
    ...
    <span>Customer can cancel their order/requested services within 24 hours; refunds will be made back to the payment
        solution used initially by the customer. Please allow for up to 45days for the refund transfer to be
        completed.</span>
    <p>PRICING AND DESCRIPTION</p>
    <span>
        Our plans depend on the customer’s request, as the working hours on the project are calculated during the
        agreed-upon period, and the agreement is included in a contract concluded between our company and the customer,
        provided that we do not begin work until the customer signs and seals the contract and submits his comments,
        amendments, and conditions as well.
        Our team's working hour prices start from $40 per hour and are calculated according to each project received.
    </span>
    <p>For these security and privacy payment purposes:</p>
    <ul>
        <li>
            All credit/debit cards details and personally identifiable information will NOT be stored, sold, shared,
            rented or leased to any third parties
        </li>
        <li>
            https://www.alghadaqit.tech/will not pass any debit/credit card details to third parties
        </li>
        <li>
            https://www.alghadaqit.tech/takes appropriate steps to ensure data privacy and security including through
            various hardware and software methodologies. However https://www.alghadaqit.tech/ (website) cannot guarantee
            the security of any information that is disclosed online
        </li>
        <li>
            https://www.alghadaqit.tech/ is not responsible for the privacy policies of websites to which it links. If
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to ALGHADAQ INFORMATION TECHNOLOGY NETWORK SERVICES L.L.C,
                UAE, Abu Bakr Ahmed Obaid Bin Touq Al Marri Building, Deira Naif Area, Office No. A 5-406.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to ALGHADAQ - IT, accessible from <a href="https://alghadaqit.tech/"
                    rel="external nofollow noopener" target="_blank">https://alghadaqit.tech/</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>
            <p>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                    data-cfemail="036a6d656c43626f646b626762726a772d7766606b">[email&#160;protected]</a></p>
        </li>
        <li>
            <p>By phone number: +971 (0) 058 158 7300</p>
        </li>
    </ul>
